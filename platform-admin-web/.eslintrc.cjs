  ...
  rules: {
    ...
    'no-restricted-properties': [
      'error',
      {
        ...
        message: 'Never store the platform admin session token in localStorage. Use src/security/secureSession.ts.',
      },
    ],
  },
  overrides: [
    {
      files: ['tests/**/*', 'e2e/**/*', 'e2e-real/**/*', 'e2e-qa-coordinator-b/**/*', 'scripts/**/*', '**/*.test.ts', '**/*.test.tsx'],
      env: { node: true },
