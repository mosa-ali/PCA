...
const updates = {
  ...
  "PCA-FR-015A": {
    ...
    notes: "R3 source correction: Break Shield call pause/restore, foreground schedule handoff, typed SMS transport preservation, and transparent one-shot READ_PHONE_STATE permission UX are composed; physical call/SMS delivery remains external."
  },
  "PCA-AND-003A": {
