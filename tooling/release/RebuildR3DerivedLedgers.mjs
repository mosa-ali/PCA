...
'PCA-FR-131': {
  ...
  nextAction: 'Wire iOS source into project.pbxproj and build on macOS/Xcode; bind the live family-sync transport and clear PRODUCTION_CRYPTO_SUITE.',
  notes: 'P23 combined Prompt-2/3 programme (2026-08-22): closed under standing decision D2 (CAPABILITY_HONEST_INSTALL_APPROVAL); reclassified from OWNER_DECISION_REQUIRED_FOR_SOURCE to SOURCE_COMPLETE_EXTERNAL_GATE.',
},
'PCA-NFR-034': {
  status: 'SOURCE_COMPLETE_EXTERNAL_GATE',
