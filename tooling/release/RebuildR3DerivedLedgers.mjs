...
const SOURCE_UPDATES = {
  ...
  'PCA-FR-135': {
    status: 'PARTIAL',
    sourceEvidence: ['backend/src/location/safeZone.ts', 'android/app/src/main/java/org/pca/app/runtime/location/geofence/GeofenceEngine.kt', 'android/app/src/main/java/org/pca/app/runtime/location/geofence/SafeZonePolicyReceiver.kt', 'parent-web/src/pages/children/LocationPage.tsx', 'parent-web/src/api/real/realSafeZoneClient.ts'],
    testEvidence: ['backend/test/location/safeZone.test.mjs', 'backend/test/location/safeZoneRepository.test.mjs', 'android/app/src/test/java/org/pca/app/runtime/location/geofence/GeofenceEngineTest.kt', 'android/app/src/test/java/org/pca/app/runtime/location/geofence/SafeZonePolicyReceiverTest.kt'],
    sourceSolvableClass: 'REAL_SOURCE_GAP',
    currentGap: 'Local geofence evaluation and opaque Safe Zone boundaries are present, but the browser authoring route and verified family-authority/delivery composition are not complete.',
