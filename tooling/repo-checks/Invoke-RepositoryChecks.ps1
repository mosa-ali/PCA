...
$AllowedTopLevel = @('.agent-runtime', '.dockerignore', '.editorconfig', '.gitattributes', '.github', '.gitignore', 'README.md', 'PCA_ARCHITECTURE_MASTER_v1.0.md', 'SHA256SUMS.txt', 'CURRENT_DIRTY_PATHS.txt', 'android', 'backend', 'contracts', 'database', 'docker-compose.yml', 'docs', 'ios', 'parent-sdk', 'parent-web', 'platform-admin-web', 'public-web', 'tooling')
foreach ($Path in $TrackedFiles) {
