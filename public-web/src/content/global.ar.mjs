...
export default {
  ...
  "release.journeyNotice": "**لم يُفتح نظام الحماية الأبوية لإنشاء حسابات جديدة بعد.** تشرح هذه الصفحة رحلة الإعداد التي نعمل على بنائها حتى تعرف ما الذي تتوقعه. وسيُتاح إنشاء الحساب وتأكيد البريد الإلكتروني وتطبيق حماية الطفل في إصدار لاحق.",
  "release.contactNotice": "**لا يستطيع نظام الحماية الأبوية استقبال الرسائل بعد.** تعمل المنصة على إعداد قنوات الدعم والخصوصية والأمان، وستُنشر هنا قبل إتاحتها للأسر. وتوضح الموضوعات أدناه ما ستغطيه هذه القنوات.",
  "release.reportingPending": "لم يفتح نظام الحماية الأبوية قنوات الإبلاغ بعد. وستُنشر هذه القنوات في صفحة التواصل قبل إتاحته للأسر.",
