...
export default {
  "brand.homeLink": "الصفحة الرئيسية لنظام الحماية الأبوية",
  ...
  "nav.menu": "القائمة",
  "nav.home": "الرئيسية",
  "nav.whyPca": "لماذا نظام الحماية الأبوية؟",
  "nav.howItWorks": "كيف يعمل نظام الحماية الأبوية؟",
  ...
  "nav.faq": "المساعدة",
  "nav.about": "عن نظام الحماية الأبوية",
  ...
  "footer.legalNote": "‏نظام الحماية الأبوية منصة لحماية الأطفال في المساحات الرقمية. الخطط والأسعار وأي عناصر مذكورة على أنها «قادمة لاحقًا» لم تُطرح بعد.",
  ...
  "release.journeyNotice": "**أصبح إنشاء حساب الوالدين وتسجيل الدخول إلى منصة الوالدين متاحين الآن عبر الإنترنت.** أنشئ حسابًا، وأكّد بريدك الإلكتروني، وابدأ إعداد ميزات حماية الطفل والأجهزة المدعومة المتاحة لك حاليًا. ولا تزال بعض ميزات حماية أجهزة الأطفال قيد الاستكمال قبل إصدار تطبيقات حماية الطفل.",
  "release.contactNotice": "**منصة الوالدين متاحة عبر الإنترنت، لكن هذه الصفحة لا تستقبل الرسائل بعد.** ما زالت قنوات الدعم والخصوصية وإمكانية الوصول والأمان قيد الإعداد. وتوضح الموضوعات أدناه ما ستغطيه هذه القنوات.",
  "release.reportingPending": "لم تُفتح قنوات الإبلاغ في المنصة بعد. وستُنشر في صفحة التواصل عند توفرها. يُرجى عدم إرسال معلومات حساسة عن الأطفال عبر هذه الصفحة.",
  "notFound.seo.title": "الصفحة غير موجودة — نظام الحماية الأبوية",
  "notFound.title": "الصفحة غير موجودة",
  "notFound.body": "الصفحة التي تبحث عنها غير متاحة. ربما تكون قد نُقلت، أو أن الرابط غير مكتمل.",
  "notFound.homeCta": "اذهب إلى الصفحة الرئيسية لنظام الحماية الأبوية",
  "notFound.arabicNote": "الصفحة غير متاحة.",
  "notFound.arabicHomeCta": "العودة إلى الصفحة الرئيسية",
  "status.available": "متاح عبر الإنترنت",
  ...
  "cta.seeHowPcaWorks": "تعرّف على طريقة عمل نظام الحماية الأبوية",
  "cta.exploreFeatures": "استكشف المزايا",
  "cta.whyPca": "لماذا نظام الحماية الأبوية؟",
  "cta.howPcaWorks": "كيف يعمل نظام الحماية الأبوية؟",
  "cta.pcaParent": "منصة الوالدين",
  "cta.getTheApp": "الحصول على التطبيق",
  "cta.privacyHandling": "تعرّف على كيفية تعامل نظام الحماية الأبوية مع الخصوصية",
  "cta.childSafety": "اقرأ مبادئ سلامة الطفل",
  "cta.access": "تعرّف على خيارات الوصول إلى نظام الحماية الأبوية",
