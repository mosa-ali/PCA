...
export default {
  "brand.homeLink": "الصفحة الرئيسية لنظام الحماية الأبوية (PCA)",
  ...
  "release.journeyNotice": "**لم يُفتح نظام الحماية الأبوية لإنشاء حسابات جديدة بعد.** تشرح هذه الصفحة رحلة الإعداد التي نعمل على بنائها حتى تعرف ما الذي تتوقعه. وسيُتاح إنشاء الحساب وتأكيد البريد الإلكتروني وتطبيق الطفل (PCA Child) في إصدار لاحق.",
  ...
  "cta.pcaParent": "تطبيق الوالدين (PCA Parent)",
