...
export default {
  "home.seo.title": "نظام الحماية الأبوية PCA — حماية الأطفال في المساحات الرقمية",
  "home.seo.description": "يساعد نظام الحماية الأبوية الوالدين على توفير مساحات رقمية أكثر أمانًا للأطفال من خلال حماية عملية، وتصميم يحد من جمع المعلومات، وتحكم واضح للوالدين.",
  ...
  "home.hero.reassure": "صُمم نظام الحماية الأبوية بحيث لا ينشئ ملفًا مركزيًا مقروءًا عن النشاط الحساس لطفلك.",
  "home.why.label": "لماذا وُجد نظام الحماية الأبوية؟",
  "home.why.title": "بدأت من اهتمام أحد الوالدين بحماية أطفاله",
  "home.why.body": [
    "بدأت فكرة نظام الحماية الأبوية بسؤال بسيط: إذا كنا نبذل جهدًا لحماية الأطفال في المنزل والمدرسة والأماكن العامة، فلماذا نتعامل مع المساحات الرقمية وكأن الحماية تتوقف عندها؟",
    "نؤمن بأن الأسرة تحتاج إلى أدوات مفيدة للحماية الرقمية دون أن تضطر للتنازل عن خصوصية الطفل."
  ],
  "home.different.label": "ما الذي يميز نظام الحماية الأبوية؟",
  ...
  "home.different.items": [
    ...
    },
    {
      ...
      "body": "صُمم نهج النظام بحيث تبقى المعلومات الحساسة لدى الأسرة."
    },
    {
  ...
  "home.protects.title": "ما الذي يساعد نظام الحماية الأبوية على حمايته",
  "home.protects.body": "ما يمكن أن يفعله النظام فعليًا على جهاز معيّن يعتمد على ما تسمح به تلك المنصة. وتشرح صفحة كيف يعمل النظام كل مجال وحدوده الحالية.",
  "home.protects.items": [
    "وقت الشاشة",
    "تصفح أكثر أمانًا",
