...
export default {
  ...
  "home.availability.items": [
    ...
    },
    {
      ...
      "body": "المنصة الرئيسية المخطط لها لأول إصدار."
    },
    {
      "claimId": "CLM-026",
      "title": "PCA Child على iPhone وiPad",
      "body": "حماية الطفل على iPhone وiPad مخطط لإتاحتها في إصدار لاحق."
    }
  ],
  ...
  "home.affordability.body": "تُصمم PCA مع مراعاة أن تكون التكلفة في متناول الأسر وأن تتاح الخدمة على نطاق أوسع.",

  // --- I. أسئلة شائعة -----------------------------------------------------
  "home.faq.label": "أسئلة شائعة",
  "home.faq.title": "إجابات سريعة",
  "home.faq.items": [
    {
