...
export default {
  ...
  "home.protects.title": "ما الذي يحميه نظام الحماية الأبوية؟",
  "home.protects.body": "ما يمكن أن يفعله النظام فعليًا على جهاز معيّن يعتمد على ما تسمح به تلك المنصة. وتشرح صفحة كيف يعمل النظام مجالات الحماية وحدودها الحالية.",
  "home.protects.items": [
    "وقت الشاشة",
    "تصفح أكثر أمانًا",
