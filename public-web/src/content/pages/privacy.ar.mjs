...
export default {
  ...
  "privacy.where.items": [
    ...
    },
    {
      ...
      "body": "عندما يلزم انتقال معلومات حماية حساسة بين جهاز الوالدين وجهاز الطفل، صُمم النظام لاستخدام نقل مشفّر من طرف إلى طرف حيث يلزم. ويبقى نطاق التشفير في الإنتاج خاضعًا للمراجعة الأمنية النهائية."
    },
    {
  ...
  "privacy.honesty.body": "تحتاج أي خدمة حسابات على الإنترنت إلى قدر من المعلومات التقنية ومعلومات الحساب حتى تعمل، وأي شعار يوحي بعكس ذلك قد يكون مضللًا. والوعد الأهم هو ألا يحوّل النظام النشاط الحساس للطفل إلى قاعدة بيانات مركزية مقروءة.",
  ...
  "privacy.topics.items": [
    ...
    },
    {
      ...
      "body": "يجب ألا يتحول سجل استخدام التطبيقات المقروء إلى بيانات مركزية مقروءة لدى النظام. وقد تتم معالجة استخدام التطبيقات محليًا عند الحاجة إلى ذلك للحماية."
    },
    {
    ...
    },
    {
      ...
      "body": "حماية المسافة بين العين والشاشة باستخدام الكاميرا مخطط لها في إصدار لاحق. وهي غير متاحة حاليًا، وسنوضح هنا كيفية تعامل أي إصدار مستقبلي مع صور الكاميرا بعد التحقق من ذلك."
    }
  ],
  ...
  "privacy.retention.body": [
    "تحكم الوالدين في الحساب وفي معلومات الحماية جزء من نية تصميم النظام، لكن هذه الأدوات لم تُبنَ بعد.",
  ...
  "privacy.faq.items": [
    {
      ...
      "a": "يحتاج نظام الحماية الأبوية إلى معالجة بعض المعلومات حتى تعمل وظائف الحماية. والهدف هو إبقاء النشاط الحساس على الأجهزة الموثوقة لدى الوالدين والطفل، أو مزامنته بتشفير من طرف إلى طرف حيث يلزم، بدل إنشاء ملف مركزي مقروء لدى النظام. وفي الوقت نفسه تحتاج الخدمات المركزية إلى الحد الأدنى من معلومات الحساب والتشغيل."
    },
    {
      "q": "كيف أبلغ عن مشكلة تتعلق بالخصوصية أو الأمان؟",
      "a": "إذا كنت تعتقد أنك وجدت مشكلة أمنية، فيرجى الانتظار حتى تنشر المنصة قنوات الإبلاغ — راجع صفحة التواصل. لا ترسل معلومات حساسة عن الطفل إلا إذا طُلبت منك معلومة محددة وضرورية بطريقة آمنة."
    }
  ],
  ...
  "privacy.advanced.items": [
    {
      ...
      "body": "يعمل تطبيق الوالدين ومنصة الإدارة في بيئتين منفصلتين من ناحية الجلسات والصلاحيات. ولا يجوز أن تصبح لوحة الإدارة الداخلية طريقًا مختصرًا للدخول إلى تجربة الوالدين المحمية."
    },
    {
      "title": "لم يُصمَّم النظام للمراقبة الخفية",
      "body": "لم يُصمَّم النظام لالتقاط كلمات المرور أو الرسائل، أو اعتراض TLS بشكل خفي، أو فحص معرض الصور في الخلفية، أو تسجيل الشاشة سرًا."
    }
  ],
