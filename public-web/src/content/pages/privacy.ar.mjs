...
export default {
  ...
  "privacy.seo.description": "تعرّف على نهج PCA الذي يعطي الأولوية للمعالجة المحلية، وعلى المعلومات التي تبقى لدى الأسرة، والحد الأدنى من السجلات التقنية المركزية، ومبادئ سلامة الطفل التي يقوم عليها هذا النهج.",
  ...
  "privacy.topics.items": [
    {
      ...
      "body": "لا تحتاج الحماية المعتادة إلى الوصول إلى مكتبة صور الطفل أو مقاطع الفيديو أو الملفات الأخرى على الجهاز، ويجب ألا تُجمع هذه المحتويات في قاعدة بيانات مركزية مقروءة لدى PCA."
    },
    {
      "title": "الرسائل",
    ...
    },
    {
      ...
      "body": "يجب ألا يتحول سجل استخدام التطبيقات المقروء إلى بيانات مركزية مقروءة لدى PCA. وقد تتم معالجة استخدام التطبيقات محليًا عند الحاجة إلى ذلك للحماية."
    },
    {
      "title": "الحماية أثناء التصفح",
      "body": "قاعدة الخصوصية في PCA هي عدم حفظ سجل التصفح المقروء مركزيًا. وقد تحتاج وظائف السلامة على الويب إلى معالجة محلية لاتخاذ قرارات الحماية."
    },
    {
      "claimId": "CLM-036",
      "title": "الموقع",
  ...
  "privacy.retention.body": [
    "تحكم الوالدين في الحساب وفي معلومات الحماية جزء من نية التصميم في PCA، لكن هذه الأدوات لم تُبنَ بعد.",
  ...
  "privacy.faq.items": [
    ...
    },
    {
      ...
      "a": "إذا كنت تعتقد أنك وجدت مشكلة أمنية، فيرجى الانتظار حتى تنشر PCA قنوات الإبلاغ — راجع صفحة التواصل. لا ترسل معلومات حساسة عن الطفل إلا إذا طُلبت منك معلومة محددة وضرورية بطريقة آمنة."
    }
  ],
  ...
  "privacy.advanced.items": [
    ...
    {
      "title": "لم تُصمم PCA حول المراقبة الخفية",
