...
export default {
  ...
  "privacy.topics.items": [
    ...
    },
    {
      ...
      "body": "حماية المسافة بين العين والشاشة عبر الكاميرا مخطط لها في إصدار لاحق. وهي ليست ميزة فعّالة اليوم، وسنوضح هنا كيفية تعامل أي إصدار مستقبلي مع صور الكاميرا بعد التحقق من ذلك."
    }
  ],
