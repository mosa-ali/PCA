...
export default {
  "privacy.seo.title": "الخصوصية والسلامة في نظام الحماية الأبوية — حماية دون إنشاء ملف مركزي مقروء للطفل",
  ...
  // A — الوعد ببساطة.
  "privacy.hero.title": "نشاط طفلك يخصك أنت، وليس النظام",
  ...
  "privacy.advanced.items": [
    {
      "claimId": "CLM-046",
      "title": "الفصل بين منصة الوالدين ومنصة الإدارة",
      "body": "تعمل منصة الوالدين ومنصة الإدارة في بيئتين منفصلتين من ناحية الأمان والجلسات والأدوار والصلاحيات. ولا يجوز أن تصبح لوحة الإدارة الداخلية طريقًا مختصرًا للوصول إلى تجربة الوالدين المحمية."
    },
    {
