...
export default {
  "howItWorks.seo.title": "كيف تعمل PCA؟ — مسار الوالدين وحماية جهاز الطفل",
  "howItWorks.seo.description": "تعرّف على المسار المخطط من إنشاء حساب الوالدين إلى ربط جهاز الطفل واختيار الحماية ومتابعة الحالة.",
  ...
  "howItWorks.steps.items": [
    ...
    },
    {
      ...
      "body": "يتم استخدام مسار التسجيل والربط المعتمد."
    },
    {
      "title": "اختيار إعدادات الحماية",
      "body": "حسب الإمكانات الفعلية للمنصة، يمكن للوالدين إعداد وقت الشاشة والجداول والتحكم بالتطبيقات والويب وغيرها من وظائف الحماية المدعومة."
    },
    {
      "title": "متابعة الحالة والطلبات",
      "body": "تساعد PCA Parent الوالدين على فهم حالة الحماية والتعامل مع الطلبات المدعومة."
    }
  ],
  ...
  "howItWorks.parent.items": [
    {
      "claimId": "CLM-021",
      "title": "من المتصفح",
      "body": "استخدم PCA Parent في متصفح مدعوم على الهاتف أو الجهاز اللوحي أو الكمبيوتر."
    },
    {
      "claimId": "CLM-019",
      "title": "تثبيت PCA Parent",
      "body": "عندما يكون التثبيت مدعومًا يمكنك تثبيتها لوصول أقرب للتطبيق."
    },
    {
      "claimId": "CLM-020",
      "title": "يبقى التثبيت اختياريًا",
      "body": "لا تحتاج إلى تثبيت PCA Parent حتى تستخدم الخدمة."
    }
  ],

  "howItWorks.security.title": "فرق أمني مهم",
