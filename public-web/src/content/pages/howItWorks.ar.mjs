...
export default {
  ...
  "howItWorks.hero.body": "صُمم نظام الحماية الأبوية لتكون خطوات الحماية واضحة: أنشئ حساب الوالدين، واربط جهاز الطفل المدعوم، واختر القواعد المناسبة، ثم راجع حالة الحماية عبر منصة الوالدين.",
  ...
  "howItWorks.steps.items": [
    ...
    {
      "title": "إعداد الطفل في منصة الوالدين",
      "body": "أكمل إعداد الطفل داخل بيئة منصة الوالدين المحمية."
    },
    {
      "claimId": "CLM-024",
      "title": "تثبيت تطبيق حماية الطفل",
      "body": "اتبع الإرشادات المناسبة للجهاز الذي تقوم بإعداده."
    },
    {
      "title": "إنشاء رمز أو رابط التسجيل",
      "body": "أنشئ من داخل منصة الوالدين رمز التسجيل أو الرابط الخاص بهذا الطفل."
    },
    {
    ...
    },
    {
      ...
      "body": "وفقًا لإمكانات المنصة التي جرى التحقق منها، يمكن للوالدين إعداد قواعد وقت الشاشة والجداول والتحكم بالتطبيقات والويب وغيرها من وسائل الحماية المدعومة."
    },
    {
      "title": "متابعة الحالة والطلبات",
      "body": "ينبغي أن تساعد منصة الوالدين على معرفة ما إذا كانت الحماية تعمل والتعامل مع طلبات الطفل المدعومة."
    }
  ],
  ...
  "howItWorks.parent.items": [
    ...
    },
    {
      ...
      "body": "عندما يدعم المتصفح تثبيت تجربة المنصة كاختصار، يمكنك إضافتها للوصول إليها بسهولة أكبر."
    },
    {
      "claimId": "CLM-020",
      "title": "يبقى التثبيت اختياريًا",
      "body": "لا تحتاج إلى تثبيت شيء لمجرد استخدام الخدمة."
    }
  ],
