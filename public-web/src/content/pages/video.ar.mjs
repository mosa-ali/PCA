...
export default {
  ...
  "video.enroll.transcript": [
    "ابدأ بإنشاء حساب الوالدين في تطبيق الوالدين (PCA Parent) باستخدام بريدك الإلكتروني وكلمة مرور.",
    "ثم افتح بريدك وأكّد عنوانك الإلكتروني لتفعيل الحساب.",
    "أضف طفلك في تطبيق الوالدين، ويكفي من المعلومات ما يميّز حماية كل طفل عن غيره.",
    "اختر المنصة التي يعمل بها جهاز طفلك؛ فأندرويد هي المنصة الأولى المخطط لها لتطبيق الطفل (PCA Child)، أما حماية الأطفال على iPhone وiPad فهي مخطط لها في إصدار لاحق.",
    "أنشئ دعوة خاصة بهذا الطفل، فهي التي تربط الجهاز بأسرتك أنت دون غيرها.",
    "وعند إطلاق تطبيق الطفل ستثبّته وتفتحه على جهاز طفلك.",
    "أدخل رمز الإعداد الوارد في الدعوة، أو افتح رابط الإعداد، ليقترن جهاز الطفل بحساب الوالدين.",
    "أكّد الربط على جهاز الطفل، وامنح تطبيق الطفل الأذونات اللازمة لتطبيق القواعد التي اخترتها.",
    "عد إلى تطبيق الوالدين واختر وسائل الحماية المناسبة لهذا الطفل: وقت الشاشة، والجداول الزمنية، والتحكم بالتطبيقات والويب حيث تدعم المنصة ذلك.",
