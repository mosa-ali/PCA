 ...
 *   - video.enroll.transcript[3] uses Arabic product and device terminology;
 *     confirm the bidirectional rendering reads cleanly in the real RTL page,
 *     not just in source.
...
export default {
  ...
  "video.seo.title": "مقاطع فيديو عن نظام الحماية الأبوية — التعريف وخطوات الإعداد",
  "video.seo.description": "فيديوهان قصيران مع النص المكتوب كاملًا: لماذا وُجد نظام الحماية الأبوية، وكيف تُعِدّ الحماية لطفلك خطوة بخطوة.",

  "video.intro.title": "نبذة تعريفية عن نظام الحماية الأبوية",
  "video.intro.summary": "مقدمة قصيرة تشرح سبب وجود نظام الحماية الأبوية، وما الذي يساعدك عليه في يومك، وكيف صُمم لحماية طفلك دون إنشاء ملف مركزي مقروء عن نشاطه.",
  "video.intro.transcript": [
    ...
    "بدأ نظام الحماية الأبوية من اهتمام أبٍ بحماية أطفاله، ومن قناعة بأن حياتهم على الإنترنت ليست استثناءً.",
    "ولذلك بُني النظام لمساعدتك في الأمور اليومية، بحسب ما تدعمه منصة جهاز الطفل: وقت الشاشة، وتصفح أكثر أمانًا، والتحكم بالتطبيقات والويب، وجداول تناسب يوم أسرتك.",
    "وتنبّهك عندما يحتاج أمر ما إلى انتباهك، وتمنح طفلك طريقة واضحة ليطلب وقتًا إضافيًا أو إذنًا بالوصول.",
    "وللنظام نهج مختلف في الخصوصية: صُمم لحماية طفلك دون إنشاء ملف مركزي مقروء عنه.",
    "فالحماية اليومية لا تتطلب من النظام جمع صور طفلك أو مقاطع الفيديو أو ملفاته أو رسائله.",
    "ونؤمن بأن عالمًا رقميًا أكثر أمانًا لا ينبغي أن يرتبط بدخل الأسرة، لذلك كانت التكلفة المعقولة والإتاحة الواسعة جزءًا من تصميم النظام.",
    "ابدأ بحماية المساحات الرقمية لطفلك، وتعرّف على طريقة عمل النظام خطوة بخطوة."
  ],

  "video.enroll.title": "خطوات إعداد نظام الحماية الأبوية",
  ...
  "video.enroll.transcript": [
    "ابدأ بإنشاء حساب الوالدين في منصة الوالدين باستخدام بريدك الإلكتروني وكلمة مرور.",
    "ثم افتح بريدك وأكّد عنوانك الإلكتروني لتفعيل الحساب.",
    "أضف طفلك في منصة الوالدين، ويكفي من المعلومات ما يميّز حماية كل طفل عن غيره.",
    "اختر المنصة التي يعمل بها جهاز طفلك؛ فأندرويد هي المنصة الأولى المخطط لها لتطبيق حماية الطفل، أما حماية الأطفال على آيفون وآيباد فهي مخطط لها في إصدار لاحق.",
    "أنشئ دعوة خاصة بهذا الطفل، فهي التي تربط الجهاز بأسرتك أنت دون غيرها.",
    "وعند إطلاق تطبيق حماية الطفل ستثبّته وتفتحه على جهاز طفلك.",
    "أدخل رمز الإعداد الوارد في الدعوة، أو افتح رابط الإعداد، ليقترن جهاز الطفل بحساب الوالدين.",
    "أكّد الربط على جهاز الطفل، وامنح تطبيق حماية الطفل الأذونات اللازمة لتطبيق القواعد التي اخترتها.",
    "عد إلى منصة الوالدين واختر وسائل الحماية المناسبة لهذا الطفل: وقت الشاشة، والجداول الزمنية، والتحكم بالتطبيقات والويب حيث تدعم المنصة ذلك.",
