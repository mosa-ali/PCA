...
export default {
  ...
  "video.seo.title": "مقاطع فيديو PCA — التعريف وخطوات الإعداد",
  ...
  "video.intro.transcript": [
    ...
    "فالحماية اليومية لا تتطلب من PCA جمع صور طفلك أو مقاطع الفيديو أو ملفاته أو رسائله.",
    "ونؤمن بأن عالمًا رقميًا أكثر أمانًا لا ينبغي أن يرتبط بدخل الأسرة، لذلك كانت التكلفة المعقولة والإتاحة الواسعة جزءًا من تصميم PCA.",
  ...
  "video.enroll.transcript": [
    ...
    "اختر المنصة التي يعمل بها جهاز طفلك؛ فأندرويد هي المنصة الأولى المخطط لها في PCA Child، أما حماية الأطفال على iPhone وiPad فهي مخطط لها في إصدار لاحق.",
