...
export default {
  ...
  "video.intro.summary": "مقدمة قصيرة تشرح سبب وجود PCA، وما الذي تساعدك عليه في يومك، وكيف صُممت لحماية طفلك دون إنشاء سجل مركزي عنه.",
  "video.intro.transcript": [
    ...
    "لذلك تساعدك PCA في الأمور اليومية: وقت الشاشة، وتصفح أكثر أمانًا، والتحكم بالتطبيقات والويب، وجداول تناسب يوم أسرتك.",
