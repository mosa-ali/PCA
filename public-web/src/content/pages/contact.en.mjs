...
export default {
  "contact.seo.title": "Contact PCA — Support and Safety Topics",
  "contact.seo.description": "PCA Parent is available online, but support, privacy, accessibility and security contact channels are not open yet.",
