...
const files = [
  ...
  "test/platformadmin/mfaSecretDrainAudit.test.mjs",
  "test/platformadmin/mfaSecretReadRepair.test.mjs",
  ...
  "test/parentaccount/genesisVerifierComposition.test.mjs",
  ...
  "test/email/EmailOutboxProcessor.test.mjs",
  "test/email/EmailService.test.mjs",
  "test/email/emailDeliveryConcurrency.test.mjs",
  "test/email/emailErrorRedaction.test.mjs",
  "test/email/RejectingEmailProviderAdapter.test.mjs",
  "test/email/emailHealth.test.mjs",
  "test/runtime/gracefulShutdown.test.mjs",
  "test/runtime/environment.test.mjs",
