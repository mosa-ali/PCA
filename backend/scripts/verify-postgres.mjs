...
try {
  ...
  const expected =
    'device_public_keys,devices,enrollment_invitations,families,licenses,recovery_envelopes,relay_envelopes,release_current_pointers,release_packages,schema_migrations,security_audit_metadata,service_accounts,service_sessions';
