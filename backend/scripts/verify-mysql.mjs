...
try {
  ...
  const expected =
    'account_entitlements,action_idempotency_ledger,billing_commercial_markets,billing_country_market_rules,billing_currencies,billing_disputes,billing_invoice_lines,billing_invoices,billing_payment_attempts,billing_payment_methods,billing_payment_transactions,billing_plans,billing_price_books,billing_provider_events,billing_quotes,billing_refund_operations,billing_refunds,billing_subscriptions,commercial_notifications,commercial_quote_attribution_retry,complimentary_entitlement_grants,delete_now_ledger,device_challenges,device_protection_status,device_public_keys,devices,email_outbox,enrollment_administration_verifiers,enrollment_bootstrap_attempts,enrollment_invitation_transitions,enrollment_invitations,enrollment_protection_approval_requests,entitlement_activation_idempotency,entitlement_change_request_transitions,entitlement_change_requests,entitlement_defaults,envelope_data_version_ledger,envelope_message_idempotency_ledger,envelope_replay_ledger,eye_protection_settings,families,family_audit_events,family_authority_attestations,family_authority_chain_heads,family_authority_genesis_anchors,family_authority_request_challenges,family_child_memberships,family_member_invitations,family_parent_memberships,family_rbac_policy_config,licenses,managed_device_slot_reservations,parent_account_preferences,parent_account_security_events,parent_accounts,parent_daily_login_grants,parent_email_verification_codes,parent_genesis_challenges,parent_genesis_step_up_authorizations,parent_login_step_up_codes,parent_mfa_enrollment_tickets,parent_mfa_recovery_codes,parent_mfa_state,parent_mfa_step_up_grants,parent_password_reset_codes,platform_admin_accounts,platform_admin_activation_tokens,platform_admin_audit_events,platform_admin_login_attempts,platform_admin_mfa_state,platform_admin_role_assignments,platform_admin_security_alerts,platform_admin_sessions,platform_admin_settings,platform_admin_step_up_sessions,profile_protection_mode,protection_alerts,recovery_envelopes,relay_envelopes,release_current_pointers,release_packages,safe_zones,schema_migrations,security_audit_metadata,service_account_family_scopes,service_accounts,service_sessions,settlement_accounts,settlement_batch_items,settlement_batches,settlement_fx_snapshots,sync_sequence_progress_ledger';
