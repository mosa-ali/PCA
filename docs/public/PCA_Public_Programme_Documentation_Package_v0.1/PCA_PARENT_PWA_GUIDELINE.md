...
**Status:** First substantive PWA architecture draft  
...
**OWNER_APPROVAL_PENDING — OD-09. Recommended default:** V1 offline scope is limited to safe static application shell assets and non-sensitive public/help content. Authenticated family information must not be intentionally available offline unless a separate security/privacy design is approved.
