...
**Status:** First authoritative architecture draft  
...
## 5. Public-to-authenticated transitions
...
## 10. Access route decision

**OWNER_APPROVAL_PENDING — OD-03. Recommended default:** Use `/access` and navigation label **Access** until commercial pricing is finalized. The page may explain affordability principles and state that plan details will be published when approved. A future `/pricing` route can redirect to or replace `/access` after owner approval.

## 11. Privacy and security route decision
...
## 13. Authentication shell architecture
...
**OD-05 default:** do not request Country/Region at signup unless PUBLIC-0/legal review proves a real requirement.  
**OD-06 default:** use a neutral confirmation that the user is the parent/guardian or otherwise authorized to manage the child's protection, with final legal wording pending.  
**OD-07 default:** email verification should precede sensitive Parent onboarding where the existing auth architecture supports it.

## 14. Parent PWA entry architecture
...
## 15. Feedback architecture placement
...
## 16. SEO and discovery architecture
