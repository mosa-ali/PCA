...
--    48 schema_migrations journal rows
...
-- account_entitlements (defined by backend/migrations/0006_platform_entitlements_enrollment_limits.sql)
CREATE TABLE `account_entitlements` (
  `family_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `plan_ref` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'FREE_STARTER',
...
CREATE TABLE `billing_commercial_markets` (
  ...
  CONSTRAINT `billing_commercial_markets_currency_fk` FOREIGN KEY (`default_currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_country_market_rules (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_country_market_rules` (
  ...
  CONSTRAINT `billing_country_market_rules_market_fk` FOREIGN KEY (`commercial_market`) REFERENCES `billing_commercial_markets` (`commercial_market`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_country_market_rules_country_check` CHECK (regexp_like(`country_code`,_utf8mb4'^[A-Z]{2}$'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- billing_currencies (defined by backend/migrations/0007_billing_core.sql)
...
-- billing_disputes (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_disputes` (
  ...
  CONSTRAINT `billing_disputes_transaction_fk` FOREIGN KEY (`payment_transaction_id`) REFERENCES `billing_payment_transactions` (`payment_transaction_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_disputes_status_check` CHECK ((`status` in (_utf8mb4'OPEN',_utf8mb4'UNDER_REVIEW',_utf8mb4'WON',_utf8mb4'LOST')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- billing_invoice_lines (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_invoice_lines` (
  ...
  `line_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `billing_invoice_lines_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_invoice_lines_invoice_fk` FOREIGN KEY (`invoice_id`) REFERENCES `billing_invoices` (`invoice_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_invoice_lines_plan_fk` FOREIGN KEY (`plan_id`) REFERENCES `billing_plans` (`plan_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_invoice_lines_price_book_fk` FOREIGN KEY (`price_book_id`) REFERENCES `billing_price_books` (`price_book_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_invoices (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_invoices` (
  `invoice_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `account_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `billing_invoices_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_invoices_subscription_fk` FOREIGN KEY (`subscription_id`) REFERENCES `billing_subscriptions` (`subscription_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_payment_attempts (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_payment_attempts` (
  ...
  `increase_request_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  ...
  `currency_code` char(3) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `provider` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `provider_reference` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  ...
  CONSTRAINT `billing_payment_attempts_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_attempts_invoice_fk` FOREIGN KEY (`invoice_id`) REFERENCES `billing_invoices` (`invoice_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_attempts_payment_method_fk` FOREIGN KEY (`payment_method_id`) REFERENCES `billing_payment_methods` (`payment_method_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_attempts_price_book_fk` FOREIGN KEY (`price_book_id`) REFERENCES `billing_price_books` (`price_book_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_attempts_quote_fk` FOREIGN KEY (`quote_id`) REFERENCES `billing_quotes` (`quote_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_payment_methods (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_payment_methods` (
  ...
  `provider_payment_method_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `brand` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `display_label` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
-- billing_payment_transactions (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_payment_transactions` (
  ...
  `currency_code` char(3) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `provider` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `provider_transaction_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `quote_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  `price_book_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  `price_book_version` int unsigned NULL,
  ...
  CONSTRAINT `billing_payment_transactions_attempt_fk` FOREIGN KEY (`payment_attempt_id`) REFERENCES `billing_payment_attempts` (`payment_attempt_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_transactions_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_transactions_invoice_fk` FOREIGN KEY (`invoice_id`) REFERENCES `billing_invoices` (`invoice_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_transactions_price_book_fk` FOREIGN KEY (`price_book_id`) REFERENCES `billing_price_books` (`price_book_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_payment_transactions_quote_fk` FOREIGN KEY (`quote_id`) REFERENCES `billing_quotes` (`quote_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_plans (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_plans` (
  `plan_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `plan_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `plan_version` int unsigned NOT NULL,
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `billing_cadence` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `billing_plans_price_book_fk` FOREIGN KEY (`price_book_id`) REFERENCES `billing_price_books` (`price_book_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_price_books (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_price_books` (
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `open_active_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS ((case when ((`status` = _utf8mb4'ACTIVE') and (`effective_to` is null)) then concat(`commercial_market`,_ascii'|',`currency_code`,_ascii'|',`target_device_limit`) else NULL end)) STORED NULL,
  ...
  CONSTRAINT `billing_price_books_admin_fk` FOREIGN KEY (`created_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_price_books_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_price_books_market_fk` FOREIGN KEY (`commercial_market`) REFERENCES `billing_commercial_markets` (`commercial_market`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_provider_events (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_provider_events` (
  ...
  `processing_status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `correlation_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
-- billing_quotes (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_quotes` (
  ...
  CONSTRAINT `billing_quotes_admin_fk` FOREIGN KEY (`issued_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_quotes_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_quotes_market_fk` FOREIGN KEY (`commercial_market`) REFERENCES `billing_commercial_markets` (`commercial_market`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_refund_operations (defined by backend/migrations/0008_payment_orchestration.sql)
CREATE TABLE `billing_refund_operations` (
  `refund_operation_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `payment_transaction_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `amount_minor` bigint NOT NULL,
  `currency_code` char(3) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `reason_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `reason_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  ...
  `provider` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `provider_refund_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  ...
  CONSTRAINT `billing_refund_operations_admin_fk` FOREIGN KEY (`initiated_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_refund_operations_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_refund_operations_refund_fk` FOREIGN KEY (`refund_id`) REFERENCES `billing_refunds` (`refund_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_refund_operations_step_up_fk` FOREIGN KEY (`step_up_session_id`) REFERENCES `platform_admin_step_up_sessions` (`step_up_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_refund_operations_transaction_fk` FOREIGN KEY (`payment_transaction_id`) REFERENCES `billing_payment_transactions` (`payment_transaction_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_refunds (defined by backend/migrations/0007_billing_core.sql)
CREATE TABLE `billing_refunds` (
  ...
  `initiated_by_admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `step_up_session_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `entitlement_treatment` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'NOT_APPLICABLE',
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  ...
  CONSTRAINT `billing_refunds_admin_fk` FOREIGN KEY (`initiated_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_refunds_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_refunds_step_up_fk` FOREIGN KEY (`step_up_session_id`) REFERENCES `platform_admin_step_up_sessions` (`step_up_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_refunds_transaction_fk` FOREIGN KEY (`payment_transaction_id`) REFERENCES `billing_payment_transactions` (`payment_transaction_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- billing_subscriptions (defined by backend/migrations/0007_billing_core.sql, altered by 0031_billing_subscription_auto_renew.sql)
CREATE TABLE `billing_subscriptions` (
  ...
  `active_account_key` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS ((case when (`status` in (_utf8mb4'TRIALING',_utf8mb4'ACTIVE',_utf8mb4'PAST_DUE')) then `account_ref` else NULL end)) STORED NULL,
  ...
  CONSTRAINT `billing_subscriptions_payment_method_fk` FOREIGN KEY (`payment_method_id`) REFERENCES `billing_payment_methods` (`payment_method_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `billing_subscriptions_plan_fk` FOREIGN KEY (`plan_id`) REFERENCES `billing_plans` (`plan_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- commercial_notifications (defined by backend/migrations/0012_commercial_notifications.sql, altered by 0033_commercial_notifications_renewal_upcoming.sql)
CREATE TABLE `commercial_notifications` (
  `notification_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `account_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `resource_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `message_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
-- complimentary_entitlement_grants (defined by backend/migrations/0014_complimentary_entitlement_grants.sql)
CREATE TABLE `complimentary_entitlement_grants` (
  `grant_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `family_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `entitlement_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `reason_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `internal_note` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  ...
  CONSTRAINT `complimentary_entitlement_grants_granted_by_fk` FOREIGN KEY (`granted_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `complimentary_entitlement_grants_revoked_by_fk` FOREIGN KEY (`revoked_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `device_challenges` (
  ...
  CONSTRAINT `device_challenges_device_id_fk` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- device_protection_status (defined by backend/migrations/0024_device_protection_status.sql)
CREATE TABLE `device_protection_status` (
  `device_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `family_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `protection_level` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `updated_at` datetime(3) NOT NULL,
  PRIMARY KEY (`device_id`),
  KEY `device_protection_status_family_id_idx` (`family_id`),
  CONSTRAINT `device_protection_status_device_id_fk` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- device_public_keys (defined by backend/migrations/0001_mysql_baseline.sql)
CREATE TABLE `device_public_keys` (
  `device_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `key_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `key_purpose` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `device_public_keys_device_id_fk` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- devices (defined by backend/migrations/0001_mysql_baseline.sql, altered by 0026_browser_endpoint_registration.sql)
CREATE TABLE `devices` (
  ...
  `registered_by_account_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  PRIMARY KEY (`device_id`),
  ...
  CONSTRAINT `devices_paired_by_account_id_fk` FOREIGN KEY (`paired_by_account_id`) REFERENCES `service_accounts` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `devices_registered_by_account_id_fk` FOREIGN KEY (`registered_by_account_id`) REFERENCES `service_accounts` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- enrollment_invitation_transitions (defined by backend/migrations/0016_invitation_lifecycle_states.sql)
CREATE TABLE `enrollment_invitation_transitions` (
  `transition_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `invitation_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `from_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `to_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `enrollment_invitation_transitions_invitation_fk` FOREIGN KEY (`invitation_id`) REFERENCES `enrollment_invitations` (`invitation_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- enrollment_invitations (defined by backend/migrations/0001_mysql_baseline.sql, altered by 0016_invitation_lifecycle_states.sql, 0019_enrollment_profile_contract.sql)
CREATE TABLE `enrollment_invitations` (
  `invitation_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `family_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `child_profile_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `token_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `platform` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `requested_protection_mode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `age_ux_tier` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'YOUNG_CHILD',
  `initial_policy_profile` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'BALANCED',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `created_at` datetime(3) NOT NULL,
  `expires_at` datetime(3) NOT NULL,
  `opened_at` datetime(3) NULL,
  `install_required_at` datetime(3) NULL,
  `app_installed_at` datetime(3) NULL,
  `authorization_required_at` datetime(3) NULL,
...
CREATE TABLE `enrollment_protection_approval_requests` (
  ...
  `expires_at` datetime(3) NOT NULL,
  `reason_category` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
-- entitlement_activation_idempotency (defined by backend/migrations/0006_platform_entitlements_enrollment_limits.sql)
CREATE TABLE `entitlement_activation_idempotency` (
  ...
  CONSTRAINT `entitlement_activation_idempotency_request_id_fk` FOREIGN KEY (`request_id`) REFERENCES `entitlement_change_requests` (`request_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- entitlement_change_request_transitions (defined by backend/migrations/0006_platform_entitlements_enrollment_limits.sql)
CREATE TABLE `entitlement_change_request_transitions` (
  `transition_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `request_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `from_state` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `to_state` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `entitlement_change_request_transitions_actor_admin_id_fk` FOREIGN KEY (`actor_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `entitlement_change_request_transitions_request_id_fk` FOREIGN KEY (`request_id`) REFERENCES `entitlement_change_requests` (`request_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- entitlement_change_requests (defined by backend/migrations/0006_platform_entitlements_enrollment_limits.sql)
CREATE TABLE `entitlement_change_requests` (
  `request_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `family_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `limit_type` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `quote_kind` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `quote_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `quote_amount_minor` bigint NULL,
  `quote_currency_code` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  ...
  `decision_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `created_at` datetime(3) NOT NULL,
  `updated_at` datetime(3) NOT NULL,
  PRIMARY KEY (`request_id`),
  ...
  CONSTRAINT `entitlement_change_requests_decided_by_admin_id_fk` FOREIGN KEY (`decided_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- entitlement_defaults (defined by backend/migrations/0006_platform_entitlements_enrollment_limits.sql)
CREATE TABLE `entitlement_defaults` (
  `tier` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `parent_member_limit` int NOT NULL,
  `managed_device_limit` int NOT NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  ...
  CONSTRAINT `entitlement_defaults_updated_by_admin_id_fk` FOREIGN KEY (`updated_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- envelope_data_version_ledger (defined by backend/migrations/0002_sync_durability.sql, altered by 0004_envelope_ledger_family_scope.sql)
...
-- envelope_message_idempotency_ledger (defined by backend/migrations/0002_sync_durability.sql, altered by 0004_envelope_ledger_family_scope.sql)
...
-- envelope_replay_ledger (defined by backend/migrations/0002_sync_durability.sql, altered by 0004_envelope_ledger_family_scope.sql)
...
-- eye_protection_settings (defined by backend/migrations/0032_eye_protection_settings.sql)
...
-- family_audit_events (defined by backend/migrations/0028_family_audit_events.sql, altered by 0034_audit_alert_ciphertext_expiry.sql)
...
-- family_authority_attestations (defined by backend/migrations/0011_family_commercial_authority.sql)
CREATE TABLE `family_authority_attestations` (
  ...
  CONSTRAINT `family_authority_attestations_genesis_fk` FOREIGN KEY (`family_id`) REFERENCES `family_authority_genesis_anchors` (`family_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- family_authority_chain_heads (defined by backend/migrations/0011_family_commercial_authority.sql)
...
CREATE TABLE `family_member_invitations` (
  ...
  `pending_invited_email_hash` binary(32) GENERATED ALWAYS AS ((case when (`status` = _utf8mb4'PENDING') then `invited_email_hash` else NULL end)) STORED NULL,
  PRIMARY KEY (`invitation_id`),
...
CREATE TABLE `licenses` (
  ...
  CONSTRAINT `licenses_account_id_fk` FOREIGN KEY (`account_id`) REFERENCES `service_accounts` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `licenses_status_check` CHECK ((`status` in (_utf8mb4'ACTIVE',_utf8mb4'SUSPENDED',_utf8mb4'EXPIRED')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- managed_device_slot_reservations (defined by backend/migrations/0006_platform_entitlements_enrollment_limits.sql)
CREATE TABLE `managed_device_slot_reservations` (
  ...
  `release_reason` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
-- parent_account_preferences (defined by backend/migrations/0020_parent_preferences_safe_zones.sql)
CREATE TABLE `parent_account_preferences` (
  `account_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `language_code` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'en',
  `email_alerts_enabled` tinyint(1) NOT NULL DEFAULT 1,
  `push_requests_enabled` tinyint(1) NOT NULL DEFAULT 1,
  `email_destination` varchar(320) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `email_destination_state` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'UNVERIFIED',
  `updated_at` datetime(6) NOT NULL,
...
CREATE TABLE `parent_accounts` (
  ...
  `service_account_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  `free_access_mode` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
CREATE TABLE `parent_password_reset_codes` (
  ...
  CONSTRAINT `parent_password_reset_codes_account_fk` FOREIGN KEY (`account_id`) REFERENCES `parent_accounts` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- platform_admin_accounts (defined by backend/migrations/0005_platform_admin_identity_rbac_audit.sql)
CREATE TABLE `platform_admin_accounts` (
  ...
  `display_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `password_credential` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `disabled_at` datetime(3) NULL,
...
CREATE TABLE `platform_admin_audit_events` (
  ...
  `actor_admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  `actor_role` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `target_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `result` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `platform_admin_audit_events_actor_admin_id_fk` FOREIGN KEY (`actor_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- platform_admin_login_attempts (defined by backend/migrations/0005_platform_admin_identity_rbac_audit.sql)
CREATE TABLE `platform_admin_login_attempts` (
  `attempt_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `email_hash` varbinary(32) NOT NULL,
  `outcome` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `occurred_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`attempt_id`),
...
-- platform_admin_mfa_state (defined by backend/migrations/0005_platform_admin_identity_rbac_audit.sql)
CREATE TABLE `platform_admin_mfa_state` (
  ...
  `last_accepted_totp_counter` bigint NULL,
  PRIMARY KEY (`admin_id`),
  CONSTRAINT `platform_admin_mfa_state_admin_id_fk` FOREIGN KEY (`admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- platform_admin_role_assignments (defined by backend/migrations/0005_platform_admin_identity_rbac_audit.sql)
CREATE TABLE `platform_admin_role_assignments` (
  `assignment_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `role` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `granted_at` datetime(3) NOT NULL,
  `revoked_at` datetime(3) NULL,
  `granted_by_admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  `active_role_marker` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS ((case when (`revoked_at` is null) then `role` else NULL end)) STORED NULL,
  ...
  CONSTRAINT `platform_admin_role_assignments_admin_id_fk` FOREIGN KEY (`admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `platform_admin_role_assignments_granted_by_fk` FOREIGN KEY (`granted_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- platform_admin_security_alerts (defined by backend/migrations/0021_platform_admin_security_alerts.sql)
CREATE TABLE `platform_admin_security_alerts` (
  ...
  `kind` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `occurred_at` datetime(3) NOT NULL,
  `correlation_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `delivery_state` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'PENDING',
  ...
  CONSTRAINT `platform_admin_security_alerts_recipient_fk` FOREIGN KEY (`recipient_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `platform_admin_security_alerts_source_fk` FOREIGN KEY (`source_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- platform_admin_sessions (defined by backend/migrations/0005_platform_admin_identity_rbac_audit.sql)
CREATE TABLE `platform_admin_sessions` (
  `session_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `token_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `realm` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `issued_at` datetime(3) NOT NULL,
  `expires_at` datetime(3) NOT NULL,
  `revoked_at` datetime(3) NULL,
  ...
  CONSTRAINT `platform_admin_sessions_admin_id_fk` FOREIGN KEY (`admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- platform_admin_settings (defined by backend/migrations/0017_platform_admin_settings_family_status.sql)
CREATE TABLE `platform_admin_settings` (
  `setting_key` varchar(128) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `category` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `value_json` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `is_sensitive` tinyint(1) NOT NULL DEFAULT 0,
  `masked_display` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  ...
  CONSTRAINT `platform_admin_settings_updated_by_fk` FOREIGN KEY (`updated_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- platform_admin_step_up_sessions (defined by backend/migrations/0005_platform_admin_identity_rbac_audit.sql, altered by 0014_complimentary_entitlement_grants.sql)
CREATE TABLE `platform_admin_step_up_sessions` (
  `step_up_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `session_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `scope` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `protection_alerts` (
  ...
  `parent_device_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `trigger_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `key_epoch` int unsigned NOT NULL,
  `generated_at_utc` datetime(3) NOT NULL,
  `encrypted_payload_b64` mediumtext CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `nonce_b64` varchar(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
...
-- recovery_envelopes (defined by backend/migrations/0001_mysql_baseline.sql)
...
-- relay_envelopes (defined by backend/migrations/0001_mysql_baseline.sql)
...
-- release_current_pointers (defined by backend/migrations/0001_mysql_baseline.sql)
CREATE TABLE `release_current_pointers` (
  `package_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `platform` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
-- release_packages (defined by backend/migrations/0001_mysql_baseline.sql)
CREATE TABLE `release_packages` (
  ...
  `minimum_supported_version` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `state` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
-- safe_zones (defined by backend/migrations/0020_parent_preferences_safe_zones.sql)
CREATE TABLE `safe_zones` (
  `zone_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `family_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `recipient_endpoint_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `ciphertext` mediumblob NOT NULL,
  `nonce` varbinary(64) NOT NULL,
  `key_epoch` int unsigned NOT NULL,
  `revision` int unsigned NOT NULL DEFAULT 1,
  `delivery_state` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'PENDING_OFFLINE',
...
-- schema_migrations (defined by backend/migrations/0001_mysql_baseline.sql)
...
-- security_audit_metadata (defined by backend/migrations/0001_mysql_baseline.sql)
...
-- service_account_family_scopes (defined by backend/migrations/0001_mysql_baseline.sql)
CREATE TABLE `service_account_family_scopes` (
  ...
  CONSTRAINT `service_account_family_scopes_account_id_fk` FOREIGN KEY (`account_id`) REFERENCES `service_accounts` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- service_accounts (defined by backend/migrations/0001_mysql_baseline.sql)
...
-- service_sessions (defined by backend/migrations/0001_mysql_baseline.sql)
CREATE TABLE `service_sessions` (
  ...
  CONSTRAINT `service_sessions_account_id_fk` FOREIGN KEY (`account_id`) REFERENCES `service_accounts` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `service_sessions_token_hash_check` CHECK (regexp_like(`token_hash`,_utf8mb4'^[0-9a-f]{64}$'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- settlement_accounts (defined by backend/migrations/0015_settlement_reconciliation.sql)
CREATE TABLE `settlement_accounts` (
  `settlement_account_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `provider_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `display_label` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  CONSTRAINT `settlement_accounts_currency_fk` FOREIGN KEY (`settlement_currency`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- settlement_batch_items (defined by backend/migrations/0015_settlement_reconciliation.sql)
CREATE TABLE `settlement_batch_items` (
  ...
  CONSTRAINT `settlement_batch_items_batch_fk` FOREIGN KEY (`settlement_batch_id`) REFERENCES `settlement_batches` (`settlement_batch_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_batch_items_currency_fk` FOREIGN KEY (`currency_code`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_batch_items_transaction_fk` FOREIGN KEY (`payment_transaction_id`) REFERENCES `billing_payment_transactions` (`payment_transaction_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_batch_items_amount_check` CHECK ((`amount_minor` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- settlement_batches (defined by backend/migrations/0015_settlement_reconciliation.sql, altered by 0018_settlement_usd_normalization.sql)
CREATE TABLE `settlement_batches` (
  ...
  `status` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `provider_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `resolution_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `resolved_by_admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  `resolved_at` datetime(3) NULL,
  `created_by_admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  `usd_normalized_rate` decimal(24,10) NULL,
  `usd_normalized_recorded_at` datetime(3) NULL,
  `usd_normalized_by_admin_id` char(36) CHARACTER SET ascii COLLATE ascii_bin NULL,
  ...
  CONSTRAINT `settlement_batches_account_fk` FOREIGN KEY (`settlement_account_ref`) REFERENCES `settlement_accounts` (`settlement_account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_batches_created_by_fk` FOREIGN KEY (`created_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_batches_currency_fk` FOREIGN KEY (`settlement_currency`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_batches_resolved_by_fk` FOREIGN KEY (`resolved_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_batches_usd_norm_by_fk` FOREIGN KEY (`usd_normalized_by_admin_id`) REFERENCES `platform_admin_accounts` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- settlement_fx_snapshots (defined by backend/migrations/0015_settlement_reconciliation.sql)
CREATE TABLE `settlement_fx_snapshots` (
  ...
  CONSTRAINT `settlement_fx_snapshots_item_fk` FOREIGN KEY (`settlement_batch_item_id`) REFERENCES `settlement_batch_items` (`settlement_batch_item_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_fx_snapshots_settlement_currency_fk` FOREIGN KEY (`settlement_currency`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `settlement_fx_snapshots_source_currency_fk` FOREIGN KEY (`source_currency`) REFERENCES `billing_currencies` (`currency_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- sync_sequence_progress_ledger (defined by backend/migrations/0002_sync_durability.sql)
...
INSERT INTO `schema_migrations` (`version`) VALUES
  ('0001_mysql_baseline.sql'),
  ('0002_sync_durability.sql'),
  ('0003_enrollment_bootstrap_attempts.sql'),
  ('0004_envelope_ledger_family_scope.sql'),
  ('0005_platform_admin_identity_rbac_audit.sql'),
  ('0006_platform_entitlements_enrollment_limits.sql'),
  ('0007_billing_core.sql'),
  ('0008_payment_orchestration.sql'),
  ('0011_family_commercial_authority.sql'),
  ('0012_commercial_notifications.sql'),
  ('0013_parent_account_identity.sql'),
  ('0014_complimentary_entitlement_grants.sql'),
  ('0015_settlement_reconciliation.sql'),
  ('0016_invitation_lifecycle_states.sql'),
  ('0017_platform_admin_settings_family_status.sql'),
  ('0018_settlement_usd_normalization.sql'),
  ('0019_enrollment_profile_contract.sql'),
  ('0020_parent_preferences_safe_zones.sql'),
  ('0021_platform_admin_security_alerts.sql'),
  ('0022_enrollment_administration_persistence.sql'),
  ('0023_removal_decision_authority_persistence.sql'),
  ('0024_device_protection_status.sql'),
  ('0025_protection_alerts.sql'),
  ('0026_browser_endpoint_registration.sql'),
  ('0027_family_member_invitations.sql'),
  ('0028_family_audit_events.sql'),
  ('0029_parent_password_reset_codes.sql'),
  ('0030_verification_code_credential_binding.sql'),
  ('0031_billing_subscription_auto_renew.sql'),
  ('0032_eye_protection_settings.sql'),
  ('0033_commercial_notifications_renewal_upcoming.sql'),
  ('0034_audit_alert_ciphertext_expiry.sql'),
  ('0035_family_member_invitation_pending_uniqueness.sql'),
  ('0036_family_child_memberships.sql'),
  ...
  ('0049_parent_totp_mfa_and_family_provisioning.sql'),
  ('0050_parent_mfa_recovery_hold.sql');
